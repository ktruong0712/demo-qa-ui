...
const FeatureGrid = () => {
  return (
    <section className="py-20 px-6 lg:px-8 bg-gradient-to-r from-sky-50 via-blue-50 to-cyan-50 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex items-center text-sm font-semibold text-sky-600 group-hover:text-sky-700 transition-colors">
                Learn More
